...
class AppliancePagerFragment : Fragment() {
    ...
    private fun init() {
        ...
        itemRecyclerViewText.text = getText(R.string.homeAppliances)
        itemRecyclerView2Text.text = getText(R.string.camera)
        itemRecyclerView3Text.text = getText(R.string.audio)
