...
class ComputerPagerFragment : Fragment() {
    ...
    private fun init() {
        ...
        itemRecyclerViewText.text = getText(R.string.computer)
        itemRecyclerView2Text.text = getText(R.string.keyboard)
        itemRecyclerView3Text.text = getText(R.string.mouse)
